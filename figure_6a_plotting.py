...
sns.lineplot(x = shifts, y = mean_surrogates, palette = "Set3", linewidth = 4, label = "Local Permutation\nSurrogate")
plt.fill_between(shifts, mean_surrogates - std_surrogates, mean_surrogates + std_surrogates, alpha = 0.5)
sns.lineplot(x = shifts, y = mean_shift_surrogates, palette = "Set3", linewidth = 4, label = "Shifted Surrogate")
